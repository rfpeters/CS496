...
app.router.add(webapp2.Route(r'/shelter/<sid:[0-9]+>/dog/<did:[0-9]+>', 'shelter.ShelterDog'))
app.router.add(webapp2.Route(r'/shelter/<sid:[0-9]+>/cat/<cid:[0-9]+>', 'shelter.Shelter'))
